          ...
          <Accordion type="single" collapsible className="w-full md:w-1/2">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                ...
                be provided, and your therapist will help you prepare to manage
                any anxiety.
                <br /> <br />
                ...
                discomfort or low mood, which we address early to ensure support
                is in place throughout therapy.
              </AccordionContent>
            </AccordionItem>
