          ...
          <div className="flex w-full max-w-section flex-col md:flex-row md:gap-6">
            <Accordion type="single" collapsible className="w-full md:w-1/2">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  next day by an ACT-based integration session. These
                  integration sessions help process the psychedelic experience
                  and embed insights into ongoing therapy. Weekly exercises
                  ...
                  stuck in distress or addiction, we can develop rigid patterns
                  to avoid emotional pain. ACT helps gradually shift this
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  ...
                  widely used in the UK. Due to risks associated with
                  recreational misuse, it is classified as a Class B controlled
                  substance under the Misuse of Drugs Act 1971. This means it is
                  illegal to buy, possess, or sell ketamine without proper
                  ...
                  <br /> <br />
                  Prescribing any medication off-label requires the prescriber
                  to be confident that:
                  <ul className="ml-4 mt-2 list-inside list-disc">
                    <li>
                      Licensed alternatives have been tried and found
                      ineffective,
                    </li>
                    <li>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger>
                  Is this treatment safe? Does it have any risks or side
                  effects?
                </AccordionTrigger>
                <AccordionContent>
                  Ketamine is a safe anaesthetic, even at doses much higher than
                  those used in therapy. It does not suppress breathing and
                  mildly stimulates the heart, making it suitable for use
                  without advanced airway support. It is listed as an essential
                  medicine by the WHO.
                  <br /> <br />
                  While ketamine has abuse potential, therapeutic use under
                  medical supervision has a very low risk of serious side
                  effects. Common side effects include nausea, headache,
                  dizziness, or anxiety, which are usually temporary.
                  Anti-nausea medication can be provided, and your therapist
                  will help you prepare to manage any anxiety.
                  <br /> <br />
                  ...
                  effects can feel unsettling but also offer therapeutic value.
                  As with other psychedelics, mindset and setting greatly
                  influence the experience. Rarely, sessions may lead to
                  emotional discomfort or low mood, which we address early to
                  ensure support is in place throughout therapy.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  At the start of each ketamine session, our nurse will check
                  your vitals (pulse, blood pressure) to ensure you&apos;re
                  ready. Your therapist will accompany you to the therapy room,
                  which you&apos;ll already know from preparatory sessions.
                  You&apos;ll settle on a couch with a weighted blanket, and can
                  choose to wear headphones and an eye-mask to support an
                  inward-focused experience—these will have been introduced
                  earlier. <br /> <br />
                  In preparatory sessions, you&apos;ll also discuss with your
                  therapist how you&apos;d like them to support you if you
                  become anxious during the session. This may include reassuring
                  physical contact, such as holding your hand—always guided by
                  your preferences. <br /> <br />
                  The nurse will prepare and administer ketamine via a single
                  injection into your upper arm (like a flu jab). The initial
                  dose is at the lower end of the effective range and may be
                  adjusted over time in agreement with you and the clinical
                  team, prescribed by our psychiatrist. <br /> <br />
                  ...
                  hospital sedation. If needed, we can help arrange a
                  professional chaperone. You must not drive or cycle until the
                  next day.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
            <Accordion type="single" collapsible className="w-full md:w-1/2">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Ketamine induces non-ordinary states of consciousness that
                  vary depending on dose, mindset, and setting. In
                  ketamine-assisted psychotherapy, preparatory sessions help you
                  approach the experience with openness and curiosity, including
                  strategies to lean into discomfort if it arises. While fear
                  can occur, it is generally uncommon. <br /> <br />
                  ...
                  Unlike intravenous ketamine used medically for
                  depression—where dissociative effects are minimized - at Aion
                  these psychedelic aspects are embraced for their therapeutic
                  value. They are more likely to occur with a single
                  intramuscular injection, the method used in our approach.{" "}
                  <br /> <br />
                  ...
                  integrated during follow-up therapy sessions. This window is
                  considered crucial for deepening therapeutic progress and
                  applying new perspectives in daily life.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>
                ...
                <AccordionContent>
                  ...
                  sessions of therapy - 4 ketamine dosing sessions (2 hours
                  each) and 7 sessions of talking therapy (1 hour each).
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  ...
                  contains medically verified and reviewed information for you
                  to take a look through. <br /> <br />
                  ...
                  directly, please use the link below for our contact
                  information. <br /> <br />
