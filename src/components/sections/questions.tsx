        ...
        <Accordion type="single" collapsible className="w-full md:w-1/2">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              you the mental space to overcome that which has held you back. On
              a neurochemical level, ketamine is an NMDA antagonist working
              ...
              effective and safe treatment. Ketamine is understood to increase
              brain plasticity (flexibility) and connectivity, meaning it can
              help a person become more adaptive and open to new perspectives.
               {" "}
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              “off-label” for treatment of mental health and addiction. This
              means that it can be used legally in controlled clinical
              environments for clearly defined purposes. For use in mental
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              ketamine. Ketamine-Assisted Therapy uses significantly lower doses
              that are tailored to the recipient, so the risk is further
              minimised. All patients are carefully screened and fully monitored
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              mitigate these. The most common psychological side effects are
              ...
              this. Physically, you may feel lightheaded or dizzy at points;
              ...
              notice these experiences so we can support you. You will be
              ...
              to improve your experience and the safety of our procedure. Our
              clinic has dedicated recovery space which can be used for as long
              as required.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
        <Accordion type="single" collapsible className="w-full md:w-1/2">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              session. Our nurse will then prepare the ketamine and deliver the
              agreed dose as an injection in the top of your shoulder (similar
              to how you get vaccinated). You are then able to lie down, put on
              ...
              psychiatrist on standby. Effects will likely start after five
              ...
              as long as needed before going home. You will not be able to drive
              ...
              you would rather not involve friends or family.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>
            ...
            <AccordionContent>
              ...
              body’ type experience. Given the low dose we use, you are likely
              to feel a gentle sense of detachment, alongside a feeling of fresh
              perspective, enabling you to review past issues from a new angle.
