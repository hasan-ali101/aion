...
const getTreatmentSteps = (isHomePage: boolean) => [
  ...
  },
  {
    ...
    description: `${isHomePage ? "Dosing" : "Ketamine"} sessions are followed by talking therapy the next day to discuss and integrate experiences, supporting therapeutic change.`,
    info: (
      <div>
        <CheckBullet className="text-left text-sm font-medium">
          {`4 ${isHomePage ? "Dosing" : "Ketamine"} Sessions`}
        </CheckBullet>
        <CheckBullet className="text-left text-sm font-medium">
  ...
  return (
    <FadeIn>
      ...
      >
        ...
        precise ${isHomePage ? "doses of medication" : "doses of ketamine"} to facilitate therapeutic change and deliver
